...
import {
  ...
  slot,
  wrap_snippet
} from "./chunk-BCYDPNJA.js";
import "./chunk-DEX2RCYB.js";
import {
  append,
  comment,
  from_html
} from "./chunk-EXRCWBBJ.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
  ...
  set,
  untrack
} from "./chunk-LGTILZ43.js";
import "./chunk-MYSVDRKU.js";
import "./chunk-3LUZOQLA.js";
import "./chunk-XCY6J452.js";
import "./chunk-4MRSUKVS.js";
import "./chunk-NNIHVWYK.js";

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/classNames/classNames.js
function classNames(...classes) {
  return classes.filter(Boolean).join(" ");
}

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/forOwn/forOwn.js
...
// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/getSlides/getSlides.js
...
// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/isObject/isObject.js
function isObject(subject) {
  return subject !== null && typeof subject === "object";
}

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/isEqualDeep/isEqualDeep.js
...
// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/isEqualShallow/isEqualShallow.js
function isEqualShallow(array1, array2) {
  return array1.length === array2.length && !array1.some((elm, index) => elm !== array2[index]);
}

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/utils/merge/merge.js
...
function children(parent, selector) {
  ...
  return selector ? children2.filter(function(child3) {
...
function style(elm, prop2, value) {
  if (isUndefined(value)) {
    return getComputedStyle(elm)[prop2];
  }
  if (!isNull(value)) {
    elm.style[prop2] = "" + value;
  }
}
...
function parseHtml(html) {
  return child2(new DOMParser().parseFromString(html, "text/html").body);
}
...
function Direction(Splide2, Components2, options) {
  function resolve(prop2, axisOnly, direction) {
    direction = direction || options.direction;
    var index = direction === RTL && !axisOnly ? 1 : direction === TTB ? 0 : -1;
    return ORIENTATION_MAP[prop2] && ORIENTATION_MAP[prop2][index] || prop2.replace(/width|left|right/i, function(match, offset) {
...
function Elements(Splide2, Components2, options) {
  ...
  function mount() {
    ...
    bind2(root3, "focusin", function() {
      toggleClass(root3, CLASS_FOCUS_IN, !!isUsingKey);
    });
  }
  function destroy(completely) {
    var attrs = ALL_ATTRIBUTES.concat("style");
    empty(slides);
    removeClass(root3, rootClasses);
    removeClass(track, trackClasses);
    removeAttribute([track, list], attrs);
    removeAttribute(root3, completely ? attrs : ["style", ARIA_ROLEDESCRIPTION]);
  }
  function update() {
    removeClass(root3, rootClasses);
    removeClass(track, trackClasses);
    ...
    addClass(root3, rootClasses);
    addClass(track, trackClasses);
    setAttribute(root3, ARIA_LABEL, options.label);
    setAttribute(root3, ARIA_LABELLEDBY, options.labelledby);
  }
  function collect() {
    track = find("." + CLASS_TRACK);
    list = child2(track, "." + CLASS_LIST);
  ...
  function init2() {
    var id = root3.id || uniqueId(PROJECT_CODE);
    var role = options.role;
    root3.id = id;
    track.id = track.id || id + "-track";
    list.id = list.id || id + "-list";
    if (!getAttribute(root3, ROLE) && root3.tagName !== "SECTION" && role) {
      setAttribute(root3, ROLE, role);
    }
    setAttribute(root3, ARIA_ROLEDESCRIPTION, i18n.carousel);
    setAttribute(list, ROLE, "presentation");
  }
  function find(selector) {
    var elm = query(root3, selector);
    return elm && closest(elm, "." + CLASS_ROOT) === root3 ? elm : void 0;
  }
...
function Slide$1(Splide2, index, slideIndex, slide) {
  ...
  var Components = Splide2.Components, root3 = Splide2.root, options = Splide2.options;
  var isNavigation = options.isNavigation, updateOnMove = options.updateOnMove, i18n = options.i18n, pagination = options.pagination, slideFocus = options.slideFocus;
  var resolve = Components.Direction.resolve;
  var styles = getAttribute(slide, "style");
  var label = getAttribute(slide, ARIA_LABEL);
  var isClone = slideIndex > -1;
  var container = child2(slide, "." + CLASS_CONTAINER);
  var destroyed;
  function mount() {
    if (!isClone) {
      slide.id = root3.id + "-slide" + pad(index + 1);
  ...
  function style$1(prop2, value, useContainer) {
    style(useContainer && container || slide, prop2, value);
  }
  function isActive() {
    var curr = Splide2.index;
...
function Slides(Splide2, Components2, options) {
  ...
  function style2(prop2, value, useContainer) {
    forEach$1(function(Slide2) {
      Slide2.style(prop2, value, useContainer);
    });
  }
...
function Layout(Splide2, Components2, options) {
  ...
  var _Components2$Elements2 = Components2.Elements, root3 = _Components2$Elements2.root, track = _Components2$Elements2.track, list = _Components2$Elements2.list;
  ...
  function init2() {
    ...
    style(root3, "maxWidth", unit(options.width));
    style(track, resolve("paddingLeft"), cssPadding(false));
    style(track, resolve("paddingRight"), cssPadding(true));
    resize(true);
  }
  function resize(force) {
    var newRect = rect(root3);
    if (force || rootRect.width !== newRect.width || rootRect.height !== newRect.height) {
      ...
      if (overflow !== (overflow = isOverflow())) {
        toggleClass(root3, CLASS_OVERFLOW, overflow);
  ...
  function cssPadding(right) {
    ...
    var prop2 = resolve(right ? "right" : "left");
    return padding && unit(padding[prop2] || (isObject2(padding) ? 0 : padding)) || "0px";
  }
...
function Autoplay(Splide2, Components2, options) {
  ...
  var Elements2 = Components2.Elements, _Components2$Elements4 = Components2.Elements, root3 = _Components2$Elements4.root, toggle = _Components2$Elements4.toggle;
  ...
  function listen() {
    if (options.pauseOnHover) {
      bind2(root3, "mouseenter mouseleave", function(e) {
        hovered = e.type === "mouseenter";
        autoToggle();
      });
    }
    if (options.pauseOnFocus) {
      bind2(root3, "focusin focusout", function(e) {
...
function Cover(Splide2, Components2, options) {
  ...
  function cover(cover2) {
    Components2.Slides.forEach(function(Slide2) {
      var img = child2(Slide2.container || Slide2.slide, "img");
      if (img && img.src) {
...
function Keyboard(Splide2, Components2, options) {
  ...
  function init2() {
    ...
    if (keyboard) {
      target = keyboard === "global" ? window : root3;
    ...
    Components2.Slides.forEach(function(Slide2) {
      queryAll(Slide2.slide, IMAGE_SELECTOR).forEach(function(img) {
        ...
        if (src !== img.src || srcset !== img.srcset) {
          ...
          var spinner = child2(parent, "." + className) || create("span", className, parent);
...
var _Splide = (function() {
  function _Splide2(target, options) {
    ...
    this._o = {};
    this._E = {};
    var root3 = isString(target) ? query(document, target) : target;
    assert(root3, root3 + " is invalid.");
    this.root = root3;
    options = merge2({
      label: getAttribute(root3, ARIA_LABEL) || "",
      labelledby: getAttribute(root3, ARIA_LABELLEDBY) || ""
    }, DEFAULTS, _Splide2.defaults, options || {});
    try {
      merge2(options, JSON.parse(getAttribute(root3, DATA_ATTRIBUTE)));
    } catch (e) {
...
var Style = (function() {
  ...
  _proto2.rule = function rule(selector, prop2, value, breakpoint) {
  ...
  _proto2.buildSelectors = function buildSelectors(selectors) {
    ...
    forOwn2(selectors, function(styles, selector) {
      ...
      css += selector + " {";
      forOwn2(styles, function(value, prop2) {
        if (value || value === 0) {
          css += prop2 + ": " + value + ";";
        }
      });
...
var SplideRenderer = (function() {
  ...
  SplideRenderer2.clean = function clean(splide) {
    ...
    var root3 = splide.root;
    var clones = queryAll(root3, "." + CLASS_CLONE);
    on(EVENT_MOUNTED, function() {
      remove(child2(root3, "style"));
    });
    remove(clones);
  };
  ...
  _proto3.initSlides = function initSlides() {
    var _this4 = this;
    push2(this.slides, this.contents.map(function(content, index) {
  ...
  _proto3.resolve = function resolve(prop2) {
    return camelToKebab(this.Direction.resolve(prop2));
  };
  _proto3.cssPadding = function cssPadding(options, right) {
    var padding = options.padding;
    var prop2 = this.Direction.resolve(right ? "right" : "left", true);
    return padding && unit(padding[prop2] || (isObject2(padding) ? 0 : padding)) || "0px";
  };
  ...
  _proto3.generateClones = function generateClones(contents) {
    ...
    push2(slides.slice(-count).reverse(), slides.slice(0, count)).forEach(function(content, index) {
...
// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/Splide/bind.js
...
// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/Splide/Splide.svelte
Splide_1[FILENAME] = "node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/Splide/Splide.svelte";
var root_1 = add_locations(from_html(`<div><!></div>`), Splide_1[FILENAME], [[93, 0]]);
function Splide_1($$anchor, $$props) {
  ...
  push($$props, false, Splide_1);
  var $$ownership_validator = create_ownership_validator($$props);
  let className = prop($$props, "class", 12, void 0);
  let options = prop($$props, "options", 28, () => ({}));
  let splide = prop($$props, "splide", 12, void 0);
  let extensions = prop($$props, "extensions", 12, void 0);
  let transition = prop($$props, "transition", 12, void 0);
  let hasTrack = prop($$props, "hasTrack", 12, true);
  const dispatch = createEventDispatcher();
  let root3 = mutable_source();
  let prevSlides;
  let prevOptions = mutable_source(merge({}, options()));
  onMount(() => {
    splide(new Splide(get(root3), options()));
  ...
  function go(control) {
    var _a;
    (_a = splide()) == null ? void 0 : _a.go(control);
  }
  function sync(target) {
    var _a;
    (_a = splide()) == null ? void 0 : _a.sync(target);
  }
  legacy_pre_effect(
    () => (deep_read_state(splide()), isEqualDeep, get(prevOptions), deep_read_state(options()), merge),
    () => {
      if (splide() && !isEqualDeep(get(prevOptions), options())) {
        $$ownership_validator.mutation(null, ["splide", "options"], splide(splide().options = options(), true), 54, 4);
        set(prevOptions, merge({}, get(prevOptions)));
      }
    }
  );
  legacy_pre_effect_reset();
  ...
  attribute_effect(
    ...
    [
      () => (deep_read_state(classNames), deep_read_state(className()), untrack(() => classNames("splide", className())))
    ]
  );
  var node = child(div);
  {
    var consequent = ($$anchor2) => {
      ...
      add_svelte_meta(
        () => SplideTrack_default(node_1, {
          children: wrap_snippet(Splide_1, ($$anchor3, $$slotProps) => {
  ...
  reset(div);
  bind_this(div, ($$value) => set(root3, $$value), () => get(root3));
  append($$anchor, div);
  bind_prop($$props, "go", go);
  bind_prop($$props, "sync", sync);
  return pop({
    get go() {
      return go;
    },
...
if (import.meta.hot) {
  Splide_1 = hmr(Splide_1, () => Splide_1[HMR].source);
  import.meta.hot.accept((module) => {
    module.default[HMR].source = Splide_1[HMR].source;
    set(Splide_1[HMR].source, module.default[HMR].original);
  });
}
var Splide_default = Splide_1;

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/SplideTrack/SplideTrack.svelte
SplideTrack[FILENAME] = "node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/SplideTrack/SplideTrack.svelte";
var root = add_locations(from_html(`<div><ul class="splide__list"><!></ul></div>`), SplideTrack[FILENAME], [[6, 0, [[7, 2]]]]);
function SplideTrack($$anchor, $$props) {
  check_target(new.target);
  const $$sanitized_props = legacy_rest_props($$props, ["children", "$$slots", "$$events", "$$legacy"]);
  const $$restProps = legacy_rest_props($$sanitized_props, ["class"]);
  push($$props, false, SplideTrack);
  let className = prop($$props, "class", 8, void 0);
  init();
  var div = root();
  attribute_effect(div, ($0) => ({ class: $0, ...$$restProps }), [
    () => (deep_read_state(classNames), deep_read_state(className()), untrack(() => classNames("splide__track", className())))
  ]);
  var ul = child(div);
  var node = child(ul);
...
if (import.meta.hot) {
  SplideTrack = hmr(SplideTrack, () => SplideTrack[HMR].source);
  import.meta.hot.accept((module) => {
    module.default[HMR].source = SplideTrack[HMR].source;
    set(SplideTrack[HMR].source, module.default[HMR].original);
  });
}
var SplideTrack_default = SplideTrack;

// node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/SplideSlide/SplideSlide.svelte
SplideSlide[FILENAME] = "node_modules/.pnpm/@splidejs+svelte-splide@0.2.9/node_modules/@splidejs/svelte-splide/components/SplideSlide/SplideSlide.svelte";
var root2 = add_locations(from_html(`<li><!></li>`), SplideSlide[FILENAME], [[6, 0]]);
function SplideSlide($$anchor, $$props) {
  check_target(new.target);
  const $$sanitized_props = legacy_rest_props($$props, ["children", "$$slots", "$$events", "$$legacy"]);
  const $$restProps = legacy_rest_props($$sanitized_props, ["class"]);
  push($$props, false, SplideSlide);
  let className = prop($$props, "class", 8, void 0);
  init();
  var li = root2();
  attribute_effect(li, ($0) => ({ class: $0, ...$$restProps }), [
    () => (deep_read_state(classNames), deep_read_state(className()), untrack(() => classNames("splide__slide", className())))
  ]);
  var node = child(li);
  slot(node, $$props, "default", {}, null);
  reset(li);
...
if (import.meta.hot) {
  SplideSlide = hmr(SplideSlide, () => SplideSlide[HMR].source);
  import.meta.hot.accept((module) => {
    module.default[HMR].source = SplideSlide[HMR].source;
    set(SplideSlide[HMR].source, module.default[HMR].original);
  });
}

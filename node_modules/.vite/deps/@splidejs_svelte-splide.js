...
var root_1 = add_locations(template(`<div><!></div>`), Splide_1[FILENAME], [[93, 0]]);
function Splide_1($$anchor, $$props) {
  ...
  template_effect(
    ($0) => attributes = set_attributes(div, attributes, { class: $0, ...$$restProps }),
    [
      () => classNames("splide", className())
    ],
    derived_safe_equal
  );
  append($$anchor, div);
...
var root = add_locations(template(`<div><ul class="splide__list"><!></ul></div>`), SplideTrack[FILENAME], [[6, 0, [[7, 2]]]]);
function SplideTrack($$anchor, $$props) {
  ...
  template_effect(
    ($0) => attributes = set_attributes(div, attributes, { class: $0, ...$$restProps }),
    [
      () => classNames("splide__track", className())
    ],
    derived_safe_equal
  );
  append($$anchor, div);
...
var root2 = add_locations(template(`<li><!></li>`), SplideSlide[FILENAME], [[6, 0]]);
function SplideSlide($$anchor, $$props) {
  ...
  reset(li);
  template_effect(
    ($0) => attributes = set_attributes(li, attributes, { class: $0, ...$$restProps }),
    [
      () => classNames("splide__slide", className())
    ],
    derived_safe_equal
  );
  append($$anchor, li);

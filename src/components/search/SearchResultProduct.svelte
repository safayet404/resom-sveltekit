      ...
      {#each displayed as item}
        ...
        >
          <div class="product-holder relative rounded-t-[16px]">
            ...
            <div
              class="absolute top-3 sm:top-6 right-3 sm:right-6 text-lg z-40 flex flex-col gap-2"
            >
              <!-- Favorite -->
          ...
          <div class="px-4">
            <h2
              class="capitalize text-xs mb-2 md:text-sm lg:text-base font-poppins mt-3 line-clamp-1"
            >
              {item?.name}
            </h2>

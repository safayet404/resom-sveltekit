...
<div class="mt-5">
    ...
    <div class="flex flex-col mt-5">
        <label class="text-sm" for="name">CNPJ*</label>
        <input
            class="bg-[#F0F0F0] rounded-lg p-2 mt-2"
    ...
    <div class="flex flex-col mt-5">
        <label class="text-sm" for="name">State Registration*</label>
        <input
            class="bg-[#F0F0F0] rounded-lg p-2 mt-2"
            placeholder="e.g. 123 432 988"
        />
...
<div class="mt-10">
    ...
    <div class="flex flex-col mt-5">
        <label class="text-sm" for="name">Corporate Email Address*</label>
        <input
            class="bg-[#F0F0F0] rounded-lg p-2 mt-2"
    ...
    <div class="flex flex-col mt-5 w-full">
        <label class="text-sm" for="name">Responsible Person Name *</label>
        <input
            class="bg-[#F0F0F0] rounded-lg p-2 mt-2"
            placeholder="e.g. 12354-990"
        />
